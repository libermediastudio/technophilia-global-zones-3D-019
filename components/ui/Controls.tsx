...
export const Controls: React.FC = () => {
  ...
  return (
    <div className="relative font-mono pointer-events-auto">
        {isOpen && (
            <div className="absolute bottom-full left-0 mb-2 w-56 bg-[#121212]/40 backdrop-blur-sm p-2 border border-[#E42737]/50 shadow-[0_0_20px_rgba(0,0,0,0.5)] animate-fade-in">
